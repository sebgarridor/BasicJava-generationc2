...
public class ArregloDinamico {
	...
	public static void main(String[] args) {
		...
		// 1.- Definición = ArrayList: arreglo donde no hay que definir un tamaño en su creación, se pueden agregar/quitar elementos cuando sea.
		...
		// 5.- Eliminar // remove(); para eliminar un elemento dentro del ArrayList, el resto de los elementos se corren.
		...
		for(int i = 0; i < grupo3.size(); i++){
			System.out.println("Miembro: "+grupo3.get(i));  // para obtener todos los valores dentro del arreglo debemos usar el comando .get(i);
		...
		for(String miembro: grupo3) { // for(TIPODEDATO individual: nombreArreglo){}
